...
// To build a test case, create an InterprocessHandler in your test case. This handler will run in newly created
// thread's Looper. Remember to call Looper.loop() to start handling message.
